...
const mayHoliday = holidays.find(holidays => holidays.name === 'cinco de mayo');
...
const doesEveryWordContainA = words.every(words => words.includes('a'));
...
const doesAnyWordContainX = words.some(words => words.includes('x'));
...
*/
const devLanguageCounts = developersArray.reduce((a,b) => {return { ...a,[b.language]: (a[b.language] || 0) + 1 };}, {});
